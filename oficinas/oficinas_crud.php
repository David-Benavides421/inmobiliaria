...
<body>
    <form action="/inmobiliaria/oficinas/guardar_oficinas.php" method="post" enctype="multipart/form-data">
    ...
    <label>Ubicación (Lactitud y Longitud):</label>
    ...
    <button type="button" onclick="window.location.href='/inmobiliaria/oficinas/consultar_oficinas.php'">Consutar Oficinas</button>
